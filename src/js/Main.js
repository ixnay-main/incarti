...
const APPLICATIONS = [ // TODO: move editable shortcuts to localState gun
  ...
  {url: '/order', text: t('CATALOG'), icon: Icons.home},
  {url: '/store', text: t('IN'), icon: Icons.home},
  {url: '/explorer', text: t('OUT'), icon: Icons.settings},
  {url: '/explorer', text: t('DATA'), icon: Icons.settings},
  {url: '/list', text: t('SOCIAL'), icon: Icons.settings},
  ...
  render() {
    ...
    <div class="row">
      <div class="twelve columns">
        <div class="application-list" style="display: flex">
