  ...
  newProduct() {
    ...
    return html`
      <div class="main-view" id="profile">
        <div class="content">
          <a href="/order/${Session.getPubKey()}"><iris-text path="profile/name" user=${Session.getPubKey()} /></a>
          <h3>Add itemss</h3>

          <h2 contenteditable placeholder="Item name" onInput=${e => this.newProductName = e.target.innerText} />
          
          <textarea placeholder="Item model" onInput=${e => this.newProductModel = e.target.value} style="resize: vertical"/>
          <textarea placeholder="Item stock" onInput=${e => this.newProductStock = e.target.value} style="resize: vertical"/>
